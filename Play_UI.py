...
if __name__ == "__main__":
    ...
    env = CorrectorPlayEnv(
        ...
        noise_sigma=50.0,
        user_couplings={
            # Source-Target: Coupling Factor
            "C1-A1": 0.0, "C1-A2": 0.0, "C1-B2": 0.0, "C1-A3": 0.0, "C1-S3": 0.0, "C1-C3": 0.0,
            "A1-C1": 0.0, "A1-A2": 0.0, "A1-B2": 0.0, "A1-A3": 0.0, "A1-S3": 0.0, "A1-C3": 0.0,
            "A2-C1": 0.0, "A2-A1": 0.0, "A2-B2": 0.0, "A2-A3": 0.0, "A2-S3": 0.0, "A2-C3": 0.0,
            "B2-C1": 0.0, "B2-A1": 0.0, "B2-A2": 0.0, "B2-A3": 0.0, "B2-S3": 0.0, "B2-C3": 0.0,
            "A3-C1": 0.0, "A3-A1": 0.0, "A3-A2": 0.0, "A3-B2": 0.0, "A3-S3": 0.0, "A3-C3": 0.0,
